if(USE_INSTALLED_RE2)
    # Tries to find RE2 already installed in the host
    if(WIN32)
        ...
        # -DVCPKG_TARGET_TRIPLET=<INSTALLED_RE2>-static  Examples: x64-windows-static-md, x64-mingw-static
        # Example:
        ...
        # You need to have the package "libre2-dev" installed, or similar according to the linux distribution.
        find_package(PkgConfig REQUIRED)
        pkg_check_modules(RE2 REQUIRED IMPORTED_TARGET re2)
        set(RE2_TARGETS PkgConfig::RE2)
    endif()
else()
    # Download and configure RE2
